        ...
        if event.type == VkEventType.MESSAGE_NEW and stage == 0:
            if event.to_me:
                if event.text.lower() == "начать":
                    send(event.user_id, "Привет! Я чат-бот для студентов ТУСУР.\n"
                    ...
                    send(event.user_id,
                         "Я - чат-бот из ТУСУР - Томского государственного университета систем управления и "
                         "радиоэлектроники. Меня создали студенты факультета вычислительных систем, чтобы собрать в "
                         "одном месте всю необходимую информацию для студентов.\n "
                         "О чем я могу рассказать:\n"
                         "1) Расположение и время работы корпусов, библиотеки, столовых вуза, деканатов\n"
                         "О ТУСУР->Библиотека/Столовые/Корпуса/Деканаты\n"
                         "2) Расписание занятий, успеваемость\n"
                         "Учёба->Расписание/Успеваемость\n"
                         "3) Новости, мероприятия, клубы, спорт\n"
                         "Университетская жизнь-> Новости/Мероприятия/Клубы/Спорт\n"
                         "4) Карьера\n")
                # Далее факультеты
